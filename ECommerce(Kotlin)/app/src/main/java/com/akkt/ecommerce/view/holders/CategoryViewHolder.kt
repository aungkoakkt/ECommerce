 ...
 */
class CategoryViewHolder(itemView: View, private val delegate: CategoryItemDelegate) :
    ...
    override fun setData(data: CategoryVO) {
        ...
        itemView.ivItemCategoryIcon.setColorFilter(Color.parseColor(data.categoryColor))
